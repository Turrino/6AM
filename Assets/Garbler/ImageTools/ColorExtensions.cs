...
{
    // From https://sharpsnippets.wordpress.com/2014/03/11/c-extension-complementary-color/
    public static class ColorExtensions
    {
        public static PixelInfo GetContrast(this PixelInfo source, bool preserveOpacity)
        {
            PixelInfo inputColor = source;
            ...
            return new PixelInfo ((byte)rgb.R, (byte)rgb.G, (byte)rgb.B, sourceAlphaValue);
        }
