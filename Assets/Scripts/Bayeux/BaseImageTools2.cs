...
//{
//    public abstract class BaseImageTools2<T> : IImageTools<T>
//    {
//        public BaseImageTools2(Dictionary<ObjectType, string> overlayColorRef, string overlay, string skeleton, bool restrictedPoints = false)
//        {
...
//            if (overlay != null && overlay.SourceType != layer.Definition.ObjectType)
//            {
...
//                if (!overlay.Points.ContainsKey(OverlayColorRef[layer.Definition.ObjectType]))
//                    return;
...
//            return new Overlay(colors, image.Width, image.Height, sourceType);
//        }
